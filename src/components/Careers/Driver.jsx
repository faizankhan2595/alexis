...
const RPManager = () => {
  ...
  return (
    <div className="">
      <Template name="Careers" fname="/Driver" />
          ...
          <div className="top">
            <div className="left">
              ...
              <div className="jobdesc">
                We are looking for a responsible Delivery Driver to distribute
                products promptly to our customers. You will represent our
                company in a professional and cost-effective manner to increase
                our profitability and customer satisfaction.
                <br />
                <br />
                ...
                <ul>
                  <li>
                    Deliver a wide variety of items to different addresses and
                    through different routes.
                  </li>
                  <li>Follow routes and time schedule.</li>
                  <li>
                    Load, unload, prepare, inspect and operate a delivery
                    vehicle.
                  </li>
                  <li>
                    Ask for feedback on provided services and resolve clients'
                    complaints.
                  </li>
